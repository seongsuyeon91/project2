...
function submit_ajax(){
	...
	var queryString = $("#modify_form2").serialize();
	$.ajax({
		url:'modify2.do',
		type:'POST',
		data:queryString,
		...
		success:function(json){
			...
			if(results.code=="ok"){
				alert("게시물이 수정 되었습니다.")
				window.location.replace("content_view2.do?bId="+ID);
			}else{
				alert(results.desc);
			}
		}
...
<table width="500" cellpadding="0" cellspacing="0" border="1">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	...
	<table width="500" cellpadding="0" cellspacing="0" border="1">
		<form action="modify_form2" id ="modify_form2" method="post">
			<input type="hidden" name="bId" id="bId" value="${content_view2.bId}">
			...
			<tr>
				<td>내용</td>
				<td>
				<textarea rows="10" name="bContent">${content_view2.bContent}</textarea>
				</td>
			</tr>
			<tr>
			<td colspan="2"><input type="button" value="수정" onclick="form_check()">&nbsp;&nbsp;
			<a href="content_view2.do?bId=${content_view2.bId}">취소</a>&nbsp;&nbsp;
